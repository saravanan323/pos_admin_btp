		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#composadminbtp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"composadminbtp-display": {
								"semanticObject": "composadminbtp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.posadminbtp",
									"url": sap.ui.require.toUrl("com/posadminbtp")
								}
							}
						}
					}
